...
function normalizeCatalog(raw){
  ...
  for(const a of artistsIn){
    ...
    const heroImage = a.heroImage || a.banner || `assets/artists/${artistId}/banner.jpg`;
    ...
    for(const alb of albums){
      ...
      const relCover = alb.cover || coverFallback(artistId, relTitle);
    ...
    for(const s of singles){
      ...
      const relCover = s.cover || coverFallback(artistId, relTitle);
